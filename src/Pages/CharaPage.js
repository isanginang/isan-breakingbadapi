...
const CharaPage = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://www.breakingbadapi.com/api/characters?category=Breaking+Bad&offset=0&limit=${limit}`,
        {}
      )
      .then((res) => {
  ...
  const getComments = async (offSet) => {
    await axios
      .get(
        `https://www.breakingbadapi.com/api/characters?category=Breaking+Bad&offset=${offSet}&limit=${limit}`,
        {}
      )
      .then((res) => {
        setCharacter(res.data);
      ...
      <main>
        ...
        <div className="container">
          <div className="character-page">
            <CharaList character={character} loading={loading} />
          </div>
        </div>
        <footer>
          <ReactPaginate
